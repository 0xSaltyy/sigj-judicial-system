...
export function DocumentUploader({ name = "attachments", multiple = true, required = false, accept = ".pdf,.docx,.png,.jpg,.jpeg", label = "Adjuntar documento" }: { name?: string; multiple?: boolean; required?: boolean; accept?: string; label?: string }) {
