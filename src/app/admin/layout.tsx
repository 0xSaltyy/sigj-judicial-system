...
export default async function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const [institutionResult, unreadResult, notificationsResult, avatarUrl, casesPermission, actionsPermission, proceedingsPermission, hearingsPermission, selectionPermission, noticesPermission, notificationsPermission, dependenciesPermission, usersPermission, rolesPermission, auditPermission, settingsPermission] = await Promise.all([
    ...
    can(profile,"view","audiencias",{supabase}), can(profile,"view","seleccion",{supabase}), can(profile,"view","comunicados",{supabase}), can(profile,"view","notificaciones",{supabase}),
