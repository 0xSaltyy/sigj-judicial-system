...
const users = [
  ["Attorney General Roleplay", "owner@roleplay.example", "OWNER", "Office of the Attorney General RP", "Hoy, 08:42"],
  ["Deputy Attorney General", "deputy@roleplay.example", "DEPUTY_ATTORNEY_GENERAL", "Office of the Attorney General RP", "Ayer, 16:18"],
  ["Fiscal Criminal RP", "fiscal@roleplay.example", "FISCAL", "Division of Criminal Roleplay", "18 jun, 11:30"],
  ["Jueza Civil RP", "judge.civil@roleplay.example", "JUEZ", "Civil Roleplay Division", "17 jun, 15:08"],
  ["Clerk de Docket", "clerk@roleplay.example", "SECRETARIA", "Technology & Records Unit", "Hoy, 09:01"],
  ["Investigador autorizado", "investigator@roleplay.example", "INVESTIGADOR", "Warrants & Orders Unit", "12 jun, 10:22"],
];
