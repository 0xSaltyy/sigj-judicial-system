...
export const PERMISSIONS = {
  ...
  hearingsAgenda: { resource: "audiencias", action: "ver_agenda" },
  ...
  selectionGenerateLetters: { resource: "seleccion", action: "generar_cartas" },
  selectionEditPublicLetters: { resource: "seleccion", action: "editar_cartas_publicas" },
  electionsView: { resource: "elecciones", action: "ver" },
  electionsCreate: { resource: "elecciones", action: "crear" },
  electionsEdit: { resource: "elecciones", action: "editar" },
  electionsConfigureBallot: { resource: "elecciones", action: "configurar_tarjeta" },
  electionsOpen: { resource: "elecciones", action: "abrir" },
  electionsSuspend: { resource: "elecciones", action: "suspender" },
  electionsReopen: { resource: "elecciones", action: "reabrir" },
  electionsClose: { resource: "elecciones", action: "cerrar" },
  ...
  electionsConfigureExpectedTotal: { resource: "elecciones", action: "configurar_total_esperado" },
  electionsAddVotes: { resource: "elecciones", action: "agregar_votos" },
  electionsReviewVotes: { resource: "elecciones", action: "revisar_votos" },
  electionsReturnVotes: { resource: "elecciones", action: "devolver_votos" },
  electionsRejectVotes: { resource: "elecciones", action: "rechazar_votos" },
  ...
  electionsValidateTerritorialVotes: { resource: "elecciones", action: "validar_votos_territoriales" },
  electionsRejectTerritorialVotes: { resource: "elecciones", action: "rechazar_votos_territoriales" },
  ...
  electionsPublishFinalResults: { resource: "elecciones", action: "publicar_resultados_definitivos" },
  electionsDeclareWinner: { resource: "elecciones", action: "declarar_ganador" },
  electionsAudit: { resource: "elecciones", action: "ver_auditoria" },
  electionsMapView: { resource: "elecciones", action: "ver_mapa" },
  electionsMapEdit: { resource: "elecciones", action: "editar_mapa" },
  electionsLiveRoom: { resource: "elecciones", action: "ver_sala_en_vivo" },
  electionsGenerateAct: { resource: "elecciones", action: "generar_acta" },
  electionsViewUpdates: { resource: "elecciones", action: "ver_actualizaciones" },
  electionsPublishUpdate: { resource: "elecciones", action: "publicar_actualizacion" },
  remindersView: { resource: "recordatorios", action: "ver" },
  remindersManage: { resource: "recordatorios", action: "gestionar" },
  verificationsGenerate: { resource: "verificaciones", action: "generar" },
  verificationsRevoke: { resource: "verificaciones", action: "revocar" },
  verificationsAdmin: { resource: "verificaciones", action: "ver_admin" },
