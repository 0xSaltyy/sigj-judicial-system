...
export const ROLE_DESCRIPTIONS: Record<AppRole, { label: string; scope: string; permissions: string[] }> = {
  ...
  SECRETARIO_GENERAL: { label: "Secretaría General", scope: "Certificaciones, notificaciones y coordinación secretarial.", permissions: ["Constancias", "Notificaciones", "Coordinación institucional"] },
  SECRETARIO_DESPACHO: { label: "Secretaría de Despacho", scope: "Trámite secretarial del despacho asignado.", permissions: ["Actuaciones", "Constancias", "Gestión del despacho"] },
  ...
  AUXILIAR: { label: "Auxiliar judicial", scope: "Apoyo documental y elaboración de borradores dentro de la dependencia asignada.", permissions: ["Borradores", "Carga documental", "Consulta interna en alcance"] },
